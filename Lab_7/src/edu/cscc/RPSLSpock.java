 ...
 * 10/26/21
 * Is the game "Rock, Paper, Scissors,
 * Lizard, Spock"
 */
public class RPSLSpock {
    ...
    /**
     * To ensure the user's pick is valid
     * @param pick - the user's entered value
     * @return if the pick is valid
     */
    ...
    /**
     * Generates a random pick for computer
     * @return returns a random pick
     */
     ...
     * @return true if the computer wins
     */
